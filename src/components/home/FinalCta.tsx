    ...
    >
      <div className="relative isolate">
        <div className="pointer-events-none absolute inset-0 opacity-18">
          <Image
            src="/images/sections/golden-gate-bridge-night.jpg"
            alt=""
            fill
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-relaxed text-slate-200 md:text-lg">
            If your Wi-Fi or network infrastructure has become unpredictable,
            the first step is understanding what is happening in the environment.
          </p>
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-200 md:text-lg">
            ...
            coverage gaps, interference, equipment limitations, and design
            issues before recommending next steps.
          </p>
